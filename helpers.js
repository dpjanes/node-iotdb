...
exports.difference = function(array) {
  ...
  return exports.filter(array, function(value){ return !exports.contains(rest, value); });
};
...
/**
 *  Return a new version of the object only 
...
exports.json = function(v, paramd) {
    ...
    if (exports.isArray(v)) {
        ...
        for (var ovkey in ovd) {
            ...
            var nvvalue = exports.json(ovvalue, paramd)
            if (nvvalue !== undefined) {
                var nvkey = exports.json(ovkey, paramd)
                nvd[nvkey] = nvvalue;
            }
        }
        return nvd
...
exports.expand = function(v, otherwise) {
    ...
    if (match === null) {
        if ((otherwise !== undefined) && (otherwise !== null)) {
            v = v.replace(/^:/, '')
            if (exports.isString(otherwise)) {
                otherwise = exports.expand(otherwise)
                return otherwise + v
    ...
    var url = exports.namespaced[match[1]]
...
var _traverse_namespaces = function(d, namespaces) {
    for (var key in d) {
        ...
        if ((namespace !== null) && (namespaces.indexOf(namespace) == -1)) {
            namespaces.push(namespace)
        }

        var value = d[key]
        var namespace = _get_namespace(value)
        if ((namespace !== null) && (namespaces.indexOf(namespace) == -1)) {
            namespaces.push(namespace)
        }
...
exports.dump = function(bodyd, optd) {
    ...
    if (!optd || optd.normalize) jsonld.normalize(bodyd, {format: 'application/nquads'}, function(error, result) {
        if (error) console.log("error", error);
