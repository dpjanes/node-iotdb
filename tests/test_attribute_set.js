...
describe('test_attribute_rgb:', function(){
  describe('validate string/set conversions', function(){
    it('', function(){
        var a = attribute.make_string("value").set();
        ...
        var x = a.validate_value([ 9, 8, 9, 8, 9, "8", "9" ])
        assert.ok(_.isEqual(x, [ "9", "8" ]))
  ...
  describe('validate data/set conversions', function(){
    it('', function(){
        var a = attribute.make_datetime("value").set();
